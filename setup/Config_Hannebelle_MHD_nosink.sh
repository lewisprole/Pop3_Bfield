...
#MHD_CT
#MHD_CT_IC
#MHD_CT_PERTURB_POSITIONS   # needs USE_RANDOM_GENERATOR 
MHD_DIVBCLEANING
MHD_POWELL
...
#GMC_REFINEMENT
JEANS_REFINEMENT=32
#JEANS_MASS_DEREFINE_MASS_CONDITION
##REFINEMENT_DENSITY_LIMIT=0.000117082
...
#EXACT_GRAVITY_FOR_PARTICLE_TYPE=5 #N-squared fashion gravity for a small number of particles of the given type
...
#TRACER_MC_STORE_WHAT=1+2+4+8+16+32+64+128+256+512+1024+2048+4096+8192  # bit mask for quantities to store (see allvars.h for bitmask)
...
#-------------------------------------- MONOTONE_RT
#MONOTONE_RT                   # Monotonicity Preserving anisotropic diffusion solver for RT
...
#SIDM_NO_INELASTIC                     #DEBUG: force scattering to be elastic; useful to compare elastic vs. inelastic scattering with otherwise the same cross sections
...
#SGCHEM_GONG17_TEST
#MCMA 
#SGCHEM_ALLOW_HIGH_DENSITY_DUST
#STATIC_CHEMISTRY_TEST
#ADVECTION_ONLY
#CHEM_IMAGE
#IMAGE_FOOTERS
#NO_GAS_DUST_HEAT
#FIXED_LENGTH_FOR_SELF_SHIELDING
#NO_H2_PHOTO_CHEM
#H2_ABUND_CHECK
#DEBUG_DUST_REGIME
#READ_DUST_AT_POSITION_13
#SGCHEM_OPACITY_LIMIT_APPROX
#SGCHEM_DUMP_THERMAL_RATES
#SGCHEM_DEBUG_PARTICLE=5854064
...
#-------------------------------------  ITA gmc refinement routines
#ITA_JEANS_REFINEMENT
