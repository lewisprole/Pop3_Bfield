...
shutil.copyfile(filename,'/home/c.c1521474//paul/remeshed.dat')
...
#B=(Bx,By,Bz)
			...
			arepo_input_writer.writer(sofar,'/home/c.c1521474/paul/arepo_input_beta'+str(Beta[j])+'.dat')
