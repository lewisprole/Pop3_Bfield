...
def both(file):
	...
	axs[0].set_xlabel(r'log$_{10}(\rho$ [gcm$^{-3}$])',fontsize=12)
	axs[0].set_ylabel(r'log$_{10}$(t [yrs])',fontsize=12,rotation=90)
	...
	axs[1].set_xlabel(r'log$_{10}$(R [cm])',fontsize=12)
