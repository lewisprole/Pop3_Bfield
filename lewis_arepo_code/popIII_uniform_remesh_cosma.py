...
shutil.copyfile(filename,'/cosma7/data/dp155/dc-prol1/uniform_field/remeshed.dat')
...
#B=(Bx,By,Bz)
	...
	arepo_input_writer.writer(sofar,'/cosma7/data/dp155/dc-prol1/uniform_field/0.1/arepo_input.dat')
