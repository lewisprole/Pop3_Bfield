...
V1,V2=im.min(),im.max()
im=ax1a.imshow(np.log10(np.sum(rho,1)),vmin=V1,vmax=V2,cmap='bone')
x,y,z,M=projection_functions.read_sink(A12[:-16]+'/',A12[-3:])
ax1a.scatter(z,x,s=0.5,c='magenta')
ax1a.set_xlim(0,500)
ax1a.set_ylim(0,500)
ax1a.set_aspect('auto')
ax1a.text(0.2,0.1,'800AU',ha='center', va='center', transform=ax1a.transAxes,fontsize=9,color='w')
ax1a.text(0.3,0.9,r'$\alpha$ = 0.05',ha='center', va='center', transform=ax1a.transAxes,fontsize=9,color='w')


rho=projection_functions.read_cube(A12_)
rho=rho*code_units.rho_cu
im=ax1b.imshow(np.log10(np.sum(rho,0)),vmin=V1,vmax=V2,cmap='bone')
...
cbar.set_label(r'log($\rho$ [gcm$^{-3}$])', rotation=270,fontsize=9,labelpad=15)
ax1b.set_aspect('auto')
ax1b.text(0.3,0.9,r'$\alpha$ = 0.25',ha='center', va='center', transform=ax1b.transAxes,fontsize=9,color='w')

rho=projection_functions.read_cube(B12)
rho=rho*code_units.rho_cu
im=np.log10(np.sum(rho,2))
V1,V2=im.min(),im.max()
ax2a.imshow(np.log10(np.sum(rho,2)),vmin=V1,vmax=V2,cmap='bone')
x,y,z,M=projection_functions.read_sink(B12[:-16]+'/',B12[-3:])
ax2a.scatter(y,x,s=0.5,c='magenta')
ax2a.set_xlim(0,500)
ax2a.set_ylim(0,500)
ax2a.set_aspect('auto')
ax2a.text(0.2,0.1,'670AU',ha='center', va='center', transform=ax2a.transAxes,fontsize=9,color='w')
ax2a.text(0.3,0.9,r'$\alpha$ = 0.05',ha='center', va='center', transform=ax2a.transAxes,fontsize=9,color='w')

rho=projection_functions.read_cube(C12)
rho=rho*code_units.rho_cu
im=np.log10(np.sum(rho,2))
V1,V2=im.min(),im.max()
ax3a.imshow(np.log10(np.sum(rho,2)),vmin=V1,vmax=V2,cmap='bone')
x,y,z,M=projection_functions.read_sink(C12[:-16]+'/',C12[-3:])
ax3a.scatter(y,x,s=0.5,c='magenta')
ax3a.set_xlim(0,500)
ax3a.set_ylim(0,500)
ax3a.set_aspect('auto')
ax3a.text(0.2,0.1,'670AU',ha='center', va='center', transform=ax3a.transAxes,fontsize=9,color='w')
ax3a.text(0.3,0.9,r'$\alpha$ = 0.05',ha='center', va='center', transform=ax3a.transAxes,fontsize=9,color='w')
...
ax1d.plot((t-t[0])*code_units.t_cu/(60*60*24*365),M,'b',label=r'$\alpha$ = 0.05')
t,N,M=read_sink_info.Nsinks(dirname+extensions2[0])
ax1c.plot((t-t[0])*code_units.t_cu/(60*60*24*365),N,'b',linestyle='--')
ax1d.plot((t-t[0])*code_units.t_cu/(60*60*24*365),M,'b',linestyle='--',label=r'$\alpha$ = 0.25')
ax1d.set_xlim(0,400)
ax1c.set_xlim(0,400)
ax1c.set_xticks([])
ax1c.legend(frameon=False,fontsize=9,loc=(0.55,0))

t,N,M=read_sink_info.Nsinks(dirname+extensions1[1])
ax2c.plot((t-t[0])*code_units.t_cu/(60*60*24*365),N,'r')
ax2d.plot((t-t[0])*code_units.t_cu/(60*60*24*365),M,'r',label=r'$\alpha$ = 0.05')
t,N,M=read_sink_info.Nsinks(dirname+extensions2[1])
ax2c.plot((t-t[0])*code_units.t_cu/(60*60*24*365),N,'r',linestyle='--')
ax2d.plot((t-t[0])*code_units.t_cu/(60*60*24*365),M,'r',linestyle='--',label=r'$\alpha$ = 0.25')
ax2d.set_xlim(0,400)
ax2c.set_xlim(0,400)
ax2c.set_xticks([])
ax2d.legend(frameon=False,fontsize=9,loc=(0.55,0))

t,N,M=read_sink_info.Nsinks(dirname+extensions1[2])
ax3c.plot((t-t[0])*code_units.t_cu/(60*60*24*365),N,'g')
ax3d.plot((t-t[0])*code_units.t_cu/(60*60*24*365),M,'g',label=r'$\alpha$ = 0.05')
t,N,M=read_sink_info.Nsinks(dirname+extensions2[2])
ax3c.plot((t-t[0])*code_units.t_cu/(60*60*24*365),N,'g',linestyle='--')
ax3d.plot((t-t[0])*code_units.t_cu/(60*60*24*365),M,'g',linestyle='--',label=r'$\alpha$ = 0.25')
ax3d.set_xlim(0,400)
ax3c.set_xlim(0,400)
ax3c.set_xticks([])
ax3d.legend(frameon=False,fontsize=9,loc=(0.55,0))
