...
x,y,z=spherical_spray.spherical_cloud(1e5,1e5,r,boxsize,boxsize,boxsize)    #Uniform grid with +resolution sphere
print('CODE UNITS')
...
arepo_input_writer.writer(sofar,'/scratch/c.c1521474/realistic_sphere/ics/pre_remesh_random.dat')
