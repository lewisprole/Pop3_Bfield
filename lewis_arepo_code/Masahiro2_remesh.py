...
calc_mass=sum(np.array(a.mass)[np.where(rs<r)])
print('calculated mass: '+str(calc_mass))

#add solid rotation
vx,vy,vz=velocities.rot_sphere(boxsize,(x,y,z),calc_mass,r,3e-3)
...
Bz=np.ones_like(Bx)*17e-6/code_units.B_cu
B=(Bx,By,Bz)
...
arepo_input_writer.writer(sofar,'/scratch/c.c1521474/Masahiro2/arepo_input.dat')
