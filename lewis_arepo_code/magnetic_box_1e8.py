...
filenames='/scratch/c.c1521474/resolution_test/merge/1e8_redo/snapshot_021'

a=arepo_utils.aread(filenames)
zoomzone=0.5
box=230.809
mask=masker(filenames,zoomzone)
...
#read in the Bfield from the old batch of sims
bx,by,bz=read_custom_field.reader('/scratch/c.c1521474/resolution_test/MHD/bfield.txt')
...
#		sofar=arepo_input_writer.tag_block(sofar,a.dednerv[mask],'VDED','d',1)
	...
	saveloc='/scratch/c.c1521474/resolution_test/MHD/1e8'+variants[V]+'arepo_input.dat'
