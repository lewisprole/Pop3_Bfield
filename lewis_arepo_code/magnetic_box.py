...
dirs='0.01percent','0.1percent','1percent'
for j in range(len(dirs)):


	bx,by,bz=prepare_ICs(100,0.4*d_cu,0.4*d_cu,'burgers',x,y,z,strenghh)
	...
	arepo_input_writer.writer(sofar,'/scratch/c.c1521474/magnetic_zooms/'+dirs[j]='/arepo_input.dat')
