...
filename='/scratch/c.c1521474/Masahiro/ics/snapshot_150'                #read remesh data
a=gadget_reader_lewis.reader(filename)        
shutil.copyfile(filename,'/scratch/c.c1521474/Masahiro/remeshed.dat')
...
#add solid rotation
vx,vy,vz=velocities.rot_sphere(boxsize,(x,y,z),M,r,0.02)
...
arepo_input_writer.writer(sofar,'/scratch/c.c1521474/Masahiro/arepo_input_mu1.dat')
