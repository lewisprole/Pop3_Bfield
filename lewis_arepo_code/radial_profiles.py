...
def radial_average(variable,a,weight_type,bins):
	rs=Rs(a)
...
def cycle_plot(snaps,weight_type,bins,labels):
	...
	for i in range(1):#len(snaps)):
		...
		print('averaging')
		x,v=radial_average(v,a,weight_type,bins)
		print('v')
		x,rho=radial_average(a.rho,a,weight_type,bins)
		print('rho')
		x,rv=radial_average(rv,a,weight_type,bins)
		print('radial v')
		x,nv=radial_average(nv,a,weight_type,bins)
		print('rotational v')
		x,T=radial_average(a.temp,a,weight_type,bins)
		print('T')
		x,H2=radial_average(H2,a,weight_type,bins)
		print('H2')
		x,e=radial_average(e,a,weight_type,bins)
		print('e')
	...
	axs[5].set_xlabel('R [pc]')
	
	axs[0].set_ylabel(r'$\rho$ [gcm$^{-3}$]')
