                    ...
                    /* can’t merge with itself */
                      { 
                        if (merged[j]==-1)
                          ...
                          {
#ifdef SINK_MERGERS_DEBUG
                             mpi_printf("SINK_MERGERS j = %d, i=%d",j,i);
                                          ...
                                          if (sink_mass_i>=sink_mass_j)
                                            {
                                              ...
                                              mpi_printf("SINK_MERGERS merger array ");
                                                for(z = 0; z < NSinksAllTasks; z++)
                                                 ...
                                                 mpi_printf("\n");
#endif 
                                              /*merged array is -1 for surviving sink, or the argument of the sink it will be eaten by*/
                                              for(z = 0; z < NSinksAllTasks; z++) 
            ...
            if (SinkP[eatenBy_sinkNo[i]].HomeTask == ThisTask) /*predator home task*/
              {
                ...
                P[index_survive_P].Pos[0]=(P[index_survive_P].Mass*P[index_survive_P].Pos[0] + SinkP[index_merge_SinkP].Mass*SinkP[index_merge_SinkP].Pos[0]) / (P[index_survive_P].Mass+SinkP[index_merge_SinkP].Mass);

                P[index_survive_P].Pos[1]=(P[index_survive_P].Mass*P[index_survive_P].Pos[1] + SinkP[index_merge_SinkP].Mass*SinkP[index_merge_SinkP].Pos[1]) / (P[index_survive_P].Mass+SinkP[index_merge_SinkP].Mass);

                P[index_survive_P].Pos[2]=(P[index_survive_P].Mass*P[index_survive_P].Pos[2] + SinkP[index_merge_SinkP].Mass*SinkP[index_merge_SinkP].Pos[2]) / (P[index_survive_P].Mass+SinkP[index_merge_SinkP].Mass);

                 /*transfer linear momentum*/
                P[index_survive_P].Vel[0]=(P[index_survive_P].Mass*P[index_survive_P].Vel[0] + SinkP[index_merge_SinkP].Mass*SinkP[index_merge_SinkP].Vel[0]) / (P[index_survive_P].Mass+SinkP[index_merge_SinkP].Mass);

                P[index_survive_P].Vel[1]=(P[index_survive_P].Mass*P[index_survive_P].Vel[1] + SinkP[index_merge_SinkP].Mass*SinkP[index_merge_SinkP].Vel[1]) / (P[index_survive_P].Mass+SinkP[index_merge_SinkP].Mass);

                P[index_survive_P].Vel[2]=(P[index_survive_P].Mass*P[index_survive_P].Vel[2] + SinkP[index_merge_SinkP].Mass*SinkP[index_merge_SinkP].Vel[2]) / (P[index_survive_P].Mass+SinkP[index_merge_SinkP].Mass);
                ...
                printf("SINK_MERGERS old pos (%g,%g,%g) & (%g,%g,%g) \n",SinkP[index_survive_SinkP].Pos[0],SinkP[index_survive_SinkP].Pos[1],SinkP[index_survive_SinkP].Pos[2],SinkP[index_merge_SinkP].Pos[0],SinkP[index_merge_SinkP].Pos[1],SinkP[index_merge_SinkP].Pos[2]);
                printf("SINK_MERGERS new pos (%g,%g,%g) \n",P[index_survive_P].Pos[0],P[index_survive_P].Pos[1],P[index_survive_P].Pos[2]);
                printf("SINK_MERGERS old vel (%g,%g,%g) & (%g,%g,%g) \n",SinkP[index_survive_SinkP].Vel[0],SinkP[index_survive_SinkP].Vel[1],SinkP[index_survive_SinkP].Vel[2],SinkP[index_merge_SinkP].Vel[0],SinkP[index_merge_SinkP].Vel[1],SinkP[index_merge_SinkP].Vel[2]);
                printf("SINK_MERGERS new vels (%g,%g,%g) \n",P[index_survive_P].Vel[0],P[index_survive_P].Vel[1],P[index_survive_P].Vel[0]);
